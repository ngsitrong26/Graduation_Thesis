...
def finetune(
    ...
    ################################
    '''
    Parameters for update weights of cost functions
    ...
    for epoch in range(args.num_epochs):
        ...
        while True:
            ...
            for batch in global_batch:
                ...
                ############################
                # Use additional weight updates for each cost function by averaging
                ############################
                
                required_logits_keys = ["avg_ced_logits", "avg_ckl_logits","avg_c_salience_logits"]
                required_hidden_keys = ["avg_ced_last", "avg_c5_last", "avg_c6_last"]
                ...
                if all(k in batch_logging_output for k in required_logits_keys + required_hidden_keys):
                    ...
                    try:
                        ...
                        cost_values_logits = [
                            ...
                            to_scalar(batch_logging_output["avg_ced_logits"]),
                            to_scalar(batch_logging_output["avg_ckl_logits"]),
